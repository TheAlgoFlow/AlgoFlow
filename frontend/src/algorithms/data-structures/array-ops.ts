...
const insertCodeSnippets: CodeSnippets = {
  ...
  cpp: [
    { line: 1, code: 'void insertAt(vector<int>& arr, int *n, int idx, int val) {' },
    { line: 2, code: '    (*n)++;' },
  ...
  javascript: [
    { line: 1, code: 'function insertAt(arr, idx, val) {' },
    { line: 2, code: '  arr.length++' },
    { line: 3, code: '  for (let i = arr.length - 1; i > idx; i--) {' },
    { line: 4, code: '    arr[i] = arr[i - 1]' },
    { line: 5, code: '  }' },
...
const removeCodeSnippets: CodeSnippets = {
  ...
  cpp: [
    { line: 1, code: 'void removeVal(vector<int>& arr, int *n, int val) {' },
  ...
  javascript: [
    { line: 1, code: 'function removeVal(arr, val) {' },
    { line: 2, code: '  let idx = -1' },
    { line: 3, code: '  for (let i = 0; i < arr.length; i++) {' },
    { line: 4, code: '    if (arr[i] === val) { idx = i; break }' },
    { line: 5, code: '  }' },
...
const searchCodeSnippets: CodeSnippets = {
  ...
  cpp: [
    { line: 1, code: 'int search(vector<int>& arr, int n, int val) {' },
  ...
  javascript: [
    { line: 1, code: 'function search(arr, val) {' },
    { line: 2, code: '  for (let i = 0; i < arr.length; i++) {' },
    { line: 3, code: '    if (arr[i] === val) return i' },
    { line: 4, code: '  }' },
    { line: 5, code: '  return -1' },
...
const accessCodeSnippets: CodeSnippets = {
  ...
  cpp: [
    { line: 1, code: 'int access(vector<int>& arr, int idx) {' },
    { line: 2, code: '    return arr[idx];' },
    { line: 3, code: '}' },
  ],
  csharp: [
  ...
  javascript: [
    { line: 1, code: 'function access(arr, idx) {' },
    { line: 2, code: '  return arr[idx]' },
    { line: 3, code: '}' },
  ],
}
...
export const codeSnippets: CodeSnippets = {
  ...
  cpp: [
    { line: 1, code: 'vector<int>& arr = {10, 20, 30, 40, 50};' },
    { line: 2, code: 'int n = 5;' },
  ...
  javascript: [
    { line: 1, code: 'const arr = [10, 20, 30, 40, 50]' },
    { line: 2, code: '// Access: O(1)' },
    { line: 3, code: 'const val = arr[2]  // 30' },
    { line: 4, code: '// Insert at index i: O(n)' },
    { line: 5, code: 'arr.splice(2, 0, 25)  // [10,20,25,30,40,50]' },
    ...
    { line: 7, code: 'arr.splice(1, 1)  // [10,25,30,40,50]' },
    { line: 8, code: '// Linear search: O(n)' },
    { line: 9, code: 'function linearSearch(arr, t) {' },
    { line: 10, code: '  for (let i = 0; i < arr.length; i++) {' },
    { line: 11, code: '    if (arr[i] === t) return i' },
    { line: 12, code: '  }' },
    { line: 13, code: '  return -1' },
